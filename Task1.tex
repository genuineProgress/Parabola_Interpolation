...
$(L\psi_j^h(x),\psi_i^h(x))=\int_{x_{i}}^{x_{i+1}}(-k(\psi_j^h(x))'(\psi_i^h(x))'+(\psi_j^h(x))'\psi_i^h(x)+\psi_j^h(x)\psi_i^h(x))=\frac{8h}{5}+\frac{16k}{3h},i=j$


$(L\phi_j^h(x),\psi_i^h(x))=\int_{x_{i-1}}^{x_{i+1}}(-k(\phi_j^h(x))'(\psi_i^h(x))'+(\phi_j^h(x))'\psi_i^h(x)+\phi_j^h(x)\psi_i^h(x))=\frac{2}{3}+\frac{7h}{5}+\frac{4k}{3h},i=2l,j=2l+1$

$(L\psi_j^h(x),\phi_i^h(x))=\int_{x_i-1}^{x+i+1}(-k(\psi_j^h(x))'(\phi_i^h(x))'+(\psi_j^h(x))'\phi_i^h(x)+\psi_j^h(x)\phi_j^h(x)=\frac{-2}{3}+\frac{7h}{5}+\frac{16k}{3h},i=2l,j=2l+2$
